...
set :application, "prediciendo"
set :deploy_to, "/home/prediciendo"
set :repository,  "git@github.com:jjccc/prediciendo.git"

set :scm, :git
default_run_options[:pty] = true
set :user, "root"
set :domain, "prediciendo.com"
set :use_sudo, false
...
DocumentRoot #{File.join(deploy_to, 'current', 'public')}
  ...
  task :share_uploads, :role => :app do
...
after 'deploy:finalize_update', 'deploy:db:sync_yaml', 'deploy:secret_token', 'deploy:db:migrate', "deploy:precompile", "deploy:share_uploads"
